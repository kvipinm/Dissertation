...
try:
    ...
    data=np.fromfile("./loc/global.19560721.153346.grid0.loc.scat", dtype=dt)
...
plt.savefig('1956Anjar_depth_prob.png', bbox_inches='tight')
# plt.show() 
...
fig1.savefig('1956Anjar_pdf_samples.png')
fig2.savefig('1956Anjar_stations.png')
