...
try:
    ...
    data=np.fromfile("loc/global.19640926.004637.grid0.loc.scat", dtype=dt)
...
fig1.savefig('1964Dharchula_pdf_samples.png')
fig1.show()
...
fig2.savefig('1964Dharchula_stations.png')
fig2.show()
...
plt.savefig('1964Dharchula_depth_prob.png', bbox_inches='tight')
plt.show() 
