...
try:
    ...
    data=np.fromfile("./loc/global.19750119.080300.grid0.loc.scat", dtype=dt)
...
locs=pd.read_csv('1975Kinnaur.csv')
loc1=locs.iloc[0:-1, :]
loc2=locs.iloc[-1:]
...
df.to_csv("1975Kinnaur-loc.csv", index=False)
...
for dep in locs.Depth.astype(float):
